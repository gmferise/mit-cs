# MIT Computer Science Self-Study Courselist
**Compiled By:** Gavin Ferise

Based loosely on the track at https://catalog.mit.edu/degree-charts/computer-science-engineering-course-6-3/

Rather than Semesters, courses are grouped into Phases. Each set of courses in a single Phase can be completed in any order, including in parallel, and completing a Phase will automatically fulfill the prerequisites for all courses in the next Phase. Feel free to jump ahead if desired however.

# Workload Estimations
One MIT unit is approximately equal to 14 hours of work per term (15 weeks). Most courses are 12 units, which is roughly 11.2 hours a week for 15 weeks, or 40 hours a week for 4.2 weeks.

IAP courses are 4 weeks long and likely 6 units, which is roughly 22.4 hours a week, or 40 hours a week for 2.1 weeks.

**Overall this course list is likely to take 2-2.5 years of full-time work to complete.**

## Phase 1 - Introductory Level

### 6.0001 Introduction to Programming and Computer Science
Taught in Python, beginner friendly.
...
### 6.S096A Introduction to C and C++
Taught in C and C++, beginner friendly.
...
Corequisite with [18.01SC](#1801sc-single-variable-calculus)

https://ocw.mit.edu/courses/8-01sc-classical-mechanics-fall-2016/

### 18.01SC Single Variable Calculus
A refresher on basic calculus. Prerequisites are high school algebra and trigonometry.

https://ocw.mit.edu/courses/18-01sc-single-variable-calculus-fall-2010/

## Phase 2 - Undergraduate Level

### 6.0002 Introduction to Computational Thinking and Data Science
A continuation of [6.0001](#60001-introduction-to-programming-and-computer-science). Taught in Python.

https://ocw.mit.edu/courses/6-0002-introduction-to-computational-thinking-and-data-science-fall-2016/

### 6.S096B Effective Programming in C and C++
Taught in C and C++.

Prerequisites: [6.S096A](#6s096a-introduction-to-c-and-c)
...
A continuation of [18.01SC](#1801sc-single-variable-calculus).

https://ocw.mit.edu/courses/18-02sc-multivariable-calculus-fall-2010/

## Phase 3 - Undergraduate Level

### 6.012 Introduction to Probability
Prerequisites: [18.01SC](#1801sc-single-variable-calculus), [18.02SC](#1802sc-multivariable-calculus)
...
Taught in Haskell and Coq (Rocq Prover)

Prerequisites: [6.035](#6035-computer-language-engineering)
...
Prerequisites: [8.01SC](#801sc-classical-mechanics), [18.02SC](#1802sc-multivariable-calculus)

https://ocw.mit.edu/courses/8-02-physics-ii-electricity-and-magnetism-spring-2019/

### 18.700 Linear Algebra
Prerequisites: [18.02SC](#1802sc-multivariable-calculus)

https://ocw.mit.edu/courses/18-700-linear-algebra-fall-2013/

## Phase 4 - Undergraduate Level

### 6.036 Introduction to Machine Learning
Prerequisites: [6.0002](#60002-introduction-to-computational-thinking-and-data-science), [18.700](#18700-linear-algebra)
...
Prerequisites: [18.700](#18700-linear-algebra)
...
Prerequisites: [18.02](#1802sc-multivariable-calculus), [18.700](#18700-linear-algebra)

https://ocw.mit.edu/courses/18-s096-matrix-calculus-for-machine-learning-and-beyond-january-iap-2023/

## Phase 5 - Undergraduate Level

### 6.034 Artificial Intelligence
Taught in Python.

Prerequisites: [6.036](#6036-introduction-to-machine-learning)
